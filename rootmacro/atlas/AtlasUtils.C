...
void ATLAS_LABEL_prelim(Double_t x,Double_t y,double size) 
{
  TLatex l; l.SetTextAlign(12); l.SetTextSize(size); 
  l.SetNDC();
  l.SetTextFont(72);
  l.SetTextSize(size);
  l.DrawLatex(x,y,"ATLAS #it{#bf{Preliminary}}");
}


void ATLAS_LABEL_internal(Double_t x,Double_t y,double size) 
{
  TLatex l; l.SetTextAlign(12); l.SetTextSize(size); 
  l.SetNDC();
  l.SetTextFont(72);
  l.SetTextSize(size);
  l.DrawLatex(x,y,"ATLAS #bf{internal}");
}

void ATLAS_SIM_LABEL(Double_t x,Double_t y,double size) 
{
  TLatex l; l.SetTextAlign(12); l.SetTextSize(size); 
  l.SetNDC();
  l.SetTextFont(72);
  l.SetTextSize(size);
  l.DrawLatex(x,y,"ATLAS #it{#bf{Simulation}}");
}

void ATLAS_SIM_LABEL_internal(Double_t x,Double_t y,double size) 
{
  TLatex l; l.SetTextAlign(12); l.SetTextSize(size); 
  l.SetNDC();
  l.SetTextFont(72);
  l.SetTextSize(size);
  l.DrawLatex(x,y,"#splitline{ATLAS #it{Simulation}}{#bf{#it{Internal}}}");
}
